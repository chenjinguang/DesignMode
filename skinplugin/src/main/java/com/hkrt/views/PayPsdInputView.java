...
import com.hkrt.skinplugin.R;

import static android.graphics.Paint.ANTI_ALIAS_FLAG;

/**
 * Created by wanglong on 2018/1/4.
 * 自定义密码输入框：两种样式，根据psdType进行设置：1.底部下划线   2.是密码框
 */
...
//            }
            mListener.onInputComplate(getPasswordString());
...
//        void onEqual(String psd);
        ...
        void onInputComplate(String psd);
